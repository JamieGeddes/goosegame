...
export const Mat = {
  ...
  // Library
  bookRed:      toon(0xaa2a28),
  bookBlue:     toon(0x2a44aa),
  bookGreen:    toon(0x2a7a44),
  bookYellow:   toon(0xd4a420),
  bookBrown:    toon(0x6a3820),
  shelfWood:    toon(0x6a4422),
  shelfWoodDark:toon(0x503018),
  marbleFloor:  toon(0xe4ded2),
  marbleDark:   toon(0xb8b0a2),
  alarmRed:     toon(0xe02020),
  alarmWhite:   toon(0xf8f8f8),
  paper:        toon(0xf5f0e0),
  cardigan:     toon(0x8a6aa0),
  cardiganDark: toon(0x5a3a70),
  library:      toon(0x9a8868),
  libraryDark:  toon(0x6a5838),
  signBlack:    toon(0x202020),
  floorWood:    toon(0x8a6a44),
  floorWoodDark:toon(0x6a4d2a),
  rugRed:       toon(0x8a2f2a),
  rugBlue:      toon(0x3a4a80),
  rugGreen:     toon(0x3a6a4a),
  rugBorder:    toon(0x40281a),
};
